...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `40.2µs` | `45.9µs` |
| [Day 2](./src/bin/02.rs) | `23.5ms` | `35.1ms` |
| [Day 3](./src/bin/03.rs) | `418.8µs` | `810.9µs` |
| [Day 4](./src/bin/04.rs) | `48.0µs` | `369.0µs` |
| [Day 5](./src/bin/05.rs) | `40.4µs` | `18.9µs` |
